...
const courses = [
  {
    ...
    description:
      "Master both front-end and back-end technologies to build complete, scalable web applications. Covers HTML, CSS, JavaScript, React, Node.js, Express, and Databases (SQL & NoSQL).",
  ...
  },
  {
    ...
    description:
      "Learn to extract insights from data. This track covers Python programming, data analysis, statistical modeling, machine learning algorithms, and data visualization tools like Power BI.",
  ...
  },
  {
    ...
    description:
      "Build beautiful, high-performance native apps for both iOS and Android from a single codebase using Google's Flutter framework.",
  ...
  },
  {
    ...
    description:
      "Dive into the principles of user-centric design. Learn user research, wireframing, prototyping, and visual design using tools like Figma to create intuitive digital products.",
  ...
  },
  {
    ...
    description:
      "A comprehensive program covering SEO, SEM, Content Marketing, Social Media Strategy, and Google Analytics to drive business growth online.",
    duration: "3 Months (Full-Time)",
    price: "₦150,000",
  },
];
