...
const formSchema = z.object({
  ...
  statement: z
    ...
    .min(10, "Please tell us a bit more."),
  ...
  return (
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="University of Jos" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>
            )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem className="flex flex-col">
              <FormLabel>Preferred Internship Start Date</FormLabel>
              <Popover>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder="Briefly tell us why you want to intern at Ninjabox..."
                  {...field}
                />
              </FormControl>
        ...
        <FormItem>
          <FormLabel>Upload Your IT/SIWES Letter</FormLabel>
          <FormControl>
            <Input type="file" />
          </FormControl>
          <FormMessage />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>Link to Portfolio/GitHub (Optional)</FormLabel>
              <FormControl>
                <Input
